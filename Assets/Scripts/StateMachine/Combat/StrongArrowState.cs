...
public class StrongArrowState : JabState
{
    public StrongArrowState() : base() { }

    private GameObject arrowPrefab = AssetRegistry.Instance.arrowPrefab;
    ...
    private void SpawnOrb() {
        ...
        var orb = Object.Instantiate(arrowPrefab, spawnPos + direction.normalized * 2 , Quaternion.Euler(0, angle, 0));
